...
mi[0]  <= 32'h00a00093;  // addi x1, x0, 10 
mi[1]  <= 32'h00b00113;  // addi x2, x0, 11
mi[2]  <= 32'h00c00193;  // addi x3, x0, 12
mi[3]  <= 32'h00d00213;  // addi x4, x0, 13
mi[4]  <= 32'h00100023;  // sb x1, 0(x0)
mi[5]  <= 32'h002000a3;  // sb x2, 1(x0)
mi[6]  <= 32'h00300123;  // sb x3, 2(x0)
mi[7]  <= 32'h004001a3;  // sb x4, 3(x0)
mi[8]  <= 32'h00002283;  // lw x5, 0(x0)
mi[9]  <= 32'h00001283;  // lh x5, 0(x0)
mi[10] <= 32'h00201283;  // lh x5, 2(x0)
mi[11] <= 32'h00000283;  // lb x5, 0(x0)
mi[12] <= 32'h00100283;  // lb x5, 1(x0)
mi[13] <= 32'h00200283;  // lb x5, 2(x0)
mi[14] <= 32'h00300283;  // lb x5, 3(x0)
